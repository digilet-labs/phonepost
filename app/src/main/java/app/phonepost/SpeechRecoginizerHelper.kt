...
class SpeechRecoginizerHelper(
    ...
    init {
        ...
        createSpeechRecognizerIntent(languageCode)
        setSpeechRecognizerListner()
        sendBroadcastForLanguageDetails(context)
    }

    private fun createSpeechRecognizerIntent(languageCode: String) {
        mSpeechRecognizerIntent = Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH)
        mSpeechRecognizerIntent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, languageCode)
